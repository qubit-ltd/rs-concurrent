...
///
/// ```rust,ignore
/// use prism3_rust_concurrent::double_checked_lock::ExecutorError;
///
...
impl<E> std::error::Error for ExecutorError<E>
where
...
///
/// ```rust,ignore
/// use prism3_rust_concurrent::double_checked_lock::BuilderError;
///
