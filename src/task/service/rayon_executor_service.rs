...
use rayon::{ThreadPool as RayonThreadPool, ThreadPoolBuilder as RayonThreadPoolBuilder};
use thiserror::Error;
use tokio::sync::Notify;

use crate::task::{TaskHandle, TaskResult, task_runner::run_callable};
...
impl ExecutorService for RayonExecutorService {
        ...
        E: Send + 'static,
    {
        ...
        self.pool.spawn_fifo(move || {
            ...
            completion_for_run.complete(run_callable(task));
