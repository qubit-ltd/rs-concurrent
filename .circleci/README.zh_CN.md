...
本目录包含了 `rust-concurrent` 项目的 CircleCI 持续集成配置。
...
```bash
cargo llvm-cov --package qubit-concurrent --lcov --output-path coverage.lcov
cargo llvm-cov --package qubit-concurrent
```
...
**CircleCI 仪表板**：
```
https://app.circleci.com/pipelines/github/qubit-ltd/rust-concurrent
```
...
```markdown
[![CircleCI](https://circleci.com/gh/qubit-ltd/rust-concurrent.svg?style=svg)](https://circleci.com/gh/qubit-ltd/rust-concurrent)
```

或者使用 shields.io 风格：

```markdown
[![CircleCI](https://img.shields.io/circleci/build/github/qubit-ltd/rust-concurrent/main?label=build&logo=circleci)](https://circleci.com/gh/qubit-ltd/rust-concurrent)
```

效果预览：

![CircleCI Badge](https://img.shields.io/circleci/build/github/qubit-ltd/rust-concurrent/main?label=build&logo=circleci)
...
```markdown
[![codecov](https://codecov.io/gh/qubit-ltd/rust-concurrent/branch/main/graph/badge.svg)](https://codecov.io/gh/qubit-ltd/rust-concurrent)
```
...
创建 `rust-concurrent/.cargo-audit.toml`：
...
curl -X POST \
  ...
  https://circleci.com/api/v2/project/gh/qubit-ltd/rust-concurrent/pipeline
```
...
- 🐛 Issue：[GitHub Issues](https://github.com/qubit-ltd/rust-concurrent/issues)
- 💡 讨论：[GitHub Discussions](https://github.com/qubit-ltd/rust-concurrent/discussions)
